...
var $author$project$Pre$capitalize = function (str) {
	return A2(
		$elm$core$String$join,
		' ',
		A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'data-sex',
				$elm$core$String$toLower(character.aj)),
				$elm$html$Html$Attributes$id(
				$elm$core$String$toLower(
					A2(
						$elm$core$String$join,
						'-',
						$elm$core$String$words(character.G.F))))
			]),
		_List_fromArray(
			[
				A2(
				...
				$elm$core$List$singleton(
					$elm$html$Html$Attributes$class('names')),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$span,
						...
						$elm$core$List$singleton(
							$elm$html$Html$text(
								$author$project$Pre$capitalize(character.G.F)))),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						$elm$html$Html$span,
						$elm$core$List$singleton(
							$elm$html$Html$Attributes$class('pronunciation')),
						$elm$core$List$singleton(
							$elm$html$Html$text(
								$author$project$Pre$capitalize(character.G.ad))))
					])),
				A2(
				$elm$html$Html$td,
				$elm$core$List$singleton(
					$elm$html$Html$Attributes$class('species')),
				$elm$core$List$singleton(
					$elm$html$Html$text(
						$author$project$Pre$capitalize(character.ak)))),
				A2(
				$elm$html$Html$td,
				$elm$core$List$singleton(
					$elm$html$Html$Attributes$class('extra')),
				$elm$core$List$singleton(
					$elm$html$Html$text(character.R)))
			]));
};
...
var $author$project$Pre$acute = $author$project$Pre$uni(769);
var $author$project$Pre$grave = $author$project$Pre$uni(768);
var $author$project$Pre$hacek = $author$project$Pre$uni(780);
	...
	function (n, c) {
		return _Utils_ap(
			...
			function () {
				switch (n) {
					case 1:
						return $author$project$Pre$acute;
					case 2:
						return $author$project$Pre$grave;
					case 3:
						return $author$project$Pre$hacek;
					default:
						return '';
				}
			}());
	});
var $author$project$Pre$group = F2(
	function (n, list) {
		return '[' + (A2(
			$elm$core$String$join,
			(n > 0) ? A2($author$project$Pre$em, n, '-') : '-',
			list) + ']');
	});
...
var $author$project$Main$data = _List_fromArray(
	[
		...
		{
		R: 'Shapeshifts into a large, black Wolf',
		G: {
			F: 'hound',
			ad: A2(
				$elm$core$String$join,
...
var $author$project$Main$sortedChars = A2(
		...
		return A2(
			...
			$elm$core$List$head(
				$elm$core$List$reverse(
					$elm$core$String$words(c.G.F))));
	},
	$author$project$Main$data);
var $author$project$Main$body = A2($elm$core$List$map, $author$project$Pre$char, $author$project$Main$sortedChars);
...
var $author$project$Main$main = A2(
	$elm$html$Html$table,
	$elm$core$List$singleton(
		$elm$html$Html$Attributes$id('characters')),
	_List_fromArray(
		[
			A2(
			$elm$html$Html$thead,
			...
			A2($elm$html$Html$tbody, _List_Nil, $author$project$Main$body)
		]));
